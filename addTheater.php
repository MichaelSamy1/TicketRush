...
ini_set('display_errors', 1);
  ...
  if($conn->connect_error){
    ...
    if(isset($_POST['submit'])){
		...
		VALUES ('Theater', '$event_date', '$event_time', '$event_title', '$info', '$character1', '$image')";
...
<html lang="en">
  <head>
	...
	<title>Ticket Rush | Add Theater</title>
								...
								<div class="x_content">
									...
									<form id="demo-form2" method="post" action="" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="News-date">Theater Date <span class="required">*</span>
											</label>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="News-date">Theater Time <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
