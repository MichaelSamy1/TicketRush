...
if($con->connect_error){
    die("failed to connect:".$con->connect_error);}
		...
		$update="UPDATE user
        SET firstname=?, lastname=?, email=?, date=?, gender=?, phone=?
       WHERE id=? ";
	   $st = $con->prepare($update);
	   $st->bind_param("sssssii",$firstname, $lastname, $email, $date, $gender, $phone, $id);
	   $st->execute();
...
<html lang="en">
  <head>
	...
	<title>Ticket Rush | Edit User</title>
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="../index.php" class="site_title"> <span>Ticket Rush</span></a>
					</div>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="user-name">Last name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="lastname" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="password">Gender <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
