...
ini_set('display_errors', 1);
  ...
  if($conn->connect_error){
    ...
    if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO event (event_type, event_date, event_time, event_title, info, image)
		VALUES ('Park', '$event_date', '$event_time', '$event_title', '$info', '$image')";
...
<html lang="en">
  <head>
	...
	<title>Ticket Rush | Add Park</title>
